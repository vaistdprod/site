const members = {
  ...
  "martin-studnicky": {
    ...
    "role": "Produkce",
    "about": "Kreativní megamysl s úzkostlivě perfekcionistickým smyslem pro detail. Žádný problém pro Martina není příliš velký a žádný nápad příliš šílený.",
    "skills": [
  ...
  "matyas-vanek": {
    ...
    "name": "Matyáš Vaněk",
    "role": "Management",
    "about": "Mám na starost klíčové projekty a budování dlouhodobých vztahů s našimi zákazníky. V obchodu i v zápasech vím, že klíč k úspěchu je v detailech a lidskost na prvním místě.",
    "skills": [
