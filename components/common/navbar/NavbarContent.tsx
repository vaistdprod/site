...
interface NavbarContentProps {
    onToggleNav: () => void;
    onDropdownMouseMove: (event: React.MouseEvent) => void;
    onDropdownMouseLeave: (event: React.MouseEvent) => void;
        ...
        <nav className="navbar navbar-expand-lg">
            <div className="container o-hidden">
                <Link className="logo relative icon-img-100" href="/">
                    <Image src="/assets/imgs/logo-light.svg" alt="Logo TD Productions" width={50} height={38} />
                </Link>
                <button
                ...
                <div className="contact-button relative">
                    <Link href="/kontakty" className="btn btn-sm btn-bg main-colorbg radius-5">
                        Kontaktujte nás
                    </Link>
                </div>
            </div>
